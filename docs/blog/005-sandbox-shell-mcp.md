...
在完成了[从零开始构建 Manus 系统：02-Sandbox Chrome](https://juejin.cn/post/7598104596779941934)、[从零开始构建 Manus 系统：03-Sandbox Filesystem](https://juejin.cn/post/7598362826110091314)和[# 从零开始构建 Manus 系统：04-Sandbox Shell](https://juejin.cn/spost/7598374376094580763)的 MCP Server 建设后，我们实际上是为 Agent 打造了"眼"、"手"和"脚"。但如果没有一个聪明的"大脑"来指挥，这些肢体就只是一堆散落的工具。
...
我们采用了 **LangGraph** 来构建 Agent 的认知循环，它比传统的线性 Chain 更加灵活，能够处理循环、分支和自我修正。
...
我们成功地给"四肢发达"的沙盒环境装上了一个"头脑清晰"的大脑。
